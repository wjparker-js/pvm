...
      this._sanitizer.bypassSecurityTrustStyle(data);
  ...
      this.http.get(passedurl).map(res => res.json()).subscribe(data => {
    ...
    console.log("lid1 ",lid1);
    console.log("lid2 ",lid2);
    console.log("lid3 ",lid3);
    console.log("lid4 ",lid4);
