...
function checkMessage($actionid,$actiontext,$audittext) { 
        ...
        try {
            ...
            switch ($actionid) {
                ...
                //////////////////////////////////////////////////////////////////////////////////
                    ...
                    if ($actionid = "84" and $PA5053 = "true"){
                        $message = str_replace('[IssueNumber]', $SytemOrderNumber, $audittext); 
                        $message = str_replace('[IssueType]',   $TypeNameTxt, $message);
                    ...
                    if ($actionid = "84" and $PA5053 = "false"){
                        $message = str_replace('[IssueNumber]', $SytemOrderNumber, $audittext); 
                        $message = str_replace('[IssueType]',   $TypeNameTxt, $message);
                        $message = str_replace('[Package]',     $PackageName, $message);
                    }
                ...
                case "63"; // Document Sent on Package [PackageNumber]-[PackageName]-[Recipient]
